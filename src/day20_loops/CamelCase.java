...
Ex:
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (str.charAt(i) == ' ') { // when there os a spacer character it will do some action, add thr next character as
                // uppercase as the start of the next word
                ...
                i++; // we need to change the i because we already used the start of the first word and don't
                // want to repeat it
