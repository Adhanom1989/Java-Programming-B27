...
public class StringMethods1 {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(item.equals("Pen")); // checks for exact characters including cases b/c P upper case
        ...
        // print(7)
        System.out.println(str); // print the value not the character
        ...
        System.out.println(lowerVer); // option3: reassign
